...
# Напишите программу, которая считывает натуральное число и выводит первые чисел последовательности Фибоначчи.
# Формат входных данных
# На вход программе подается одно число – количество членов последовательности.
